     ...
     <?php echo csrf_field(); ?>
      ...
      <?php for($rows = 1; $rows<=10; $rows++): ?>
        <table>
         <tr>
            <td>
            <label for="html"><?php echo e($column.$rows); ?></label>
            <input type="checkbox" id="html" name="ticketNo[]" value="<?php echo e($column.$rows); ?>">
            </td>
         </tr>
        </table>
        <?php endfor; ?>
...
<?php /**PATH C:\xampp\htdocs\ticket_booking\resources\views/welcome.blade.php ENDPATH**/ ?>